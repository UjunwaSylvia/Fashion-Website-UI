        ...
        document.addEventListener('DOMContentLoaded', function() {
            const products = [
                ...
                { title: "White Solid Format Shirt", price: 39.00, rating: 4.9 },
                ...
                { title: "Tailored Jacket", price: 46.00, rating: 4.9 },
                { title: "Solid Round Neck T-shirt", price: 36.00, rating: 5.0 }
            ];
            ...
            products.forEach((product, index) => {
                ...
                productCard.innerHTML = `
                    <div class="product-image" style="background-image: url('${placeholderImages[index]}')"></div>
